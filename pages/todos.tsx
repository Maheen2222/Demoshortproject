            ...
            <div className="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
              <div className="flex-1 flex justify-between sm:justify-between">
                <button
                  ...
                  disabled={page <= 1}
                  className="relative inline-flex items-center px-2 py-2 rounded-md border border-purple-300 text-sm font-medium text-gray-500 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Previous
                </button>
